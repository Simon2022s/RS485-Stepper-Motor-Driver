...
A PyQt5-based RS485 stepper motor driver control software with Modbus RTU protocol support. Originally designed for the [AR28 closed-loop stepper motor driver](https://www.adampower.de/nema11-rs485-stepper-motor-driver) (👈 Ctrl+Click or right-click to open in new tab), compatible with similar Modbus RTU devices.
...
- [Adam Power](https://www.adampower.de/nema11-rs485-stepper-motor-driver) (👈 Ctrl+Click or right-click to open in new tab) - AR28 stepper motor driver reference design
